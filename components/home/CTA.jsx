        ...
        <div className="relative rounded-3xl overflow-hidden glass-card p-12 md:p-20 text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="font-display text-4xl md:text-6xl font-semibold leading-tight mb-6">
              Ready to build a brand that <span className="text-gold-gradient">actually grows?</span>
            </h2>
            <p className="text-lg text-muted-foreground mb-10">
              Let's craft a strategy tailored to your business. Book a free consultation call today.
            </p>
