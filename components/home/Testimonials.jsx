    ...
    <section className="py-28 bg-navy-900/40 border-y border-gold-500/10">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {TESTIMONIALS.map((t) => (
            <div key={t.name} className="glass-card glass-card-hover rounded-2xl p-8">
              <Quote className="h-8 w-8 text-gold-500/40 mb-4" />
              <p className="text-lg leading-relaxed text-foreground/90 mb-6">“{t.quote}”</p>
              <div className="flex items-center gap-4">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={t.photo} alt={t.name} className="w-12 h-12 rounded-full object-cover border-2 border-gold-500/30" />
                <div>
