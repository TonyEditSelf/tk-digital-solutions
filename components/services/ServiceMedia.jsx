...
export default function ServiceMedia({ title }) {
  return (
    <section className="py-10">
      <div className="container">
        <div
          className="relative w-full rounded-3xl overflow-hidden glass-card group cursor-pointer"
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-5">
            <button className="w-24 h-24 rounded-full bg-gold-gradient flex items-center justify-center shadow-2xl shadow-gold-500/50 group-hover:scale-110 transition-transform duration-500 gold-border-glow">
              <Play className="h-9 w-9 text-navy-900 ml-1" fill="currentColor" strokeWidth={0} />
            </button>
