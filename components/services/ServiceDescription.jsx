      ...
      <div className="container max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="cream-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-11 h-11 rounded-lg bg-gold-gradient flex items-center justify-center shadow-md shadow-gold-500/30">
                <CheckCircle2 className="h-5 w-5" style={{ color: "#0B1C2C" }} strokeWidth={2.4} />
              </div>
              <h3 className="font-display text-2xl font-semibold" style={{ color: "#0B1C2C" }}>
                Benefits
              </h3>
            </div>
            <ul className="space-y-3">
              {service.benefits.map((b, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed" style={{ color: "#1a2c3c" }}>
                    {b}
                  </span>
                </li>
              ))}
          ...
          <div className="cream-card rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-11 h-11 rounded-lg bg-gold-gradient flex items-center justify-center shadow-md shadow-gold-500/30">
                <Package className="h-5 w-5" style={{ color: "#0B1C2C" }} strokeWidth={2.4} />
              </div>
              <h3 className="font-display text-2xl font-semibold" style={{ color: "#0B1C2C" }}>
                Key Deliverables
              </h3>
