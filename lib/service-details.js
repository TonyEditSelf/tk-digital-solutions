...
export const SERVICE_DETAILS = {
  ...
  "website-design": {
    ...
    icon: "Layout",
    description:
      "Your website is often the first impression — I make sure it lands. I design and build premium, fast websites with clean code, thoughtful UX, and conversion-focused layouts. Built on modern stacks, optimised for SEO, and crafted to grow with you.",
    benefits: [
