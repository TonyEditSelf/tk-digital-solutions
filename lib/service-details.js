...
export const SERVICE_DETAILS = {
  "social-media-growth": {
    ...
    tagline: "Turn followers into loyal customers with strategy-led social presence.",
    icon: "Share2",
    description:
      "We build and manage social media strategies that do more than look good — they drive real business outcomes. From sharp content calendars to data-backed growth experiments, we handle every layer so your brand stays consistent, relevant, and ahead of the algorithm.",
    benefits: [
  ...
  "content-creative": {
    ...
    tagline: "Scroll-stopping visuals and copy that carry your brand's premium voice.",
    icon: "PenTool",
    description:
  ...
  "website-design": {
    ...
    tagline: "Fast, elegant, high-converting websites built to scale with your business.",
    icon: "Layout",
    description:
      "Your website is often the first impression — we make sure it lands. We design and build premium, blazing-fast websites with clean code, thoughtful UX, and conversion-focused layouts. Built on modern stacks, optimised for SEO, and crafted to grow with you.",
    benefits: [
  ...
  "video-reels": {
    slug: "video-reels",
    title: "Video & Reels",
    tagline: "Short-form content engineered for reach, retention and brand recall.",
    icon: "Video",
    description:
      "Short-form video is the fastest path to attention — if it's done right. We produce reels and videos that are structured for the first-second hook, engineered for retention, and on-brand throughout. From concept to cut, every frame earns its place.",
    benefits: [
  ...
  campaigns: {
    slug: "campaigns",
    title: "Campaigns",
    tagline: "Performance-driven ad campaigns with sharp targeting and clear ROI.",
    icon: "Target",
    description:
      "We plan, launch and optimise paid campaigns that actually move the needle. From tight audience targeting to creative testing and daily optimisation, our campaigns are built to scale spend efficiently — not to burn it. Clear KPIs, clear reporting, clear outcomes.",
    benefits: [
  ...
  "automation-systems": {
    ...
    icon: "Cog",
    description:
      "Scale without chaos. We design and implement automation systems that quietly run in the background — qualifying leads, nurturing customers, syncing data, and freeing your team to focus on high-leverage work. Built with tools you already use, or better ones if needed.",
    benefits: [
      "Hours of manual work reclaimed every week",
      "Leads qualified and nurtured automatically",
      "Clean, unified data across your stack",
      "AI-assisted workflows where it matters",
    ],
    deliverables: [
