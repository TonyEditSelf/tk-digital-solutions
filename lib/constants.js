...
export const SERVICES = [
  { title: "Social Media Growth", desc: "Strategy, management & growth across platforms that matter to your audience.", icon: "Share2" },
  { title: "Content & Creative", desc: "Scroll-stopping visuals and copy that reflect your brand's premium voice.", icon: "PenTool" },
  { title: "Website Design", desc: "Fast, elegant, high-converting websites built to scale with your business.", icon: "Layout" },
  { title: "Video & Reels", desc: "Short-form content engineered for reach, retention and brand recall.", icon: "Video" },
  { title: "Campaigns", desc: "Performance-driven ad campaigns with sharp targeting and clear ROI.", icon: "Target" },
  { title: "Automation Systems", desc: "Workflows, CRM & AI-powered systems that remove repetitive work.", icon: "Cog" },
];
