...
user_problem_statement: |
  Build TK Digital Solutions website (Next.js) - premium digital agency with 3 pages:
...
agent_communication:
  - agent: "main"
    message: |
      Initial build complete for TK Digital Solutions. Please test the 3 backend endpoints:
